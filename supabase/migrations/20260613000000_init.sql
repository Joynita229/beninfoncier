...
DROP POLICY IF EXISTS "Admin reads all vendors" ON bf_vendors;
...
DROP POLICY IF EXISTS "Admin updates vendors" ON bf_vendors;
...
DROP POLICY IF EXISTS "Admin deletes vendors" ON bf_vendors;
...
DROP POLICY IF EXISTS "Admins read webhook logs" ON bf_webhook_log;
...
DROP POLICY IF EXISTS "Webhook insert disabled for users" ON bf_webhook_log;
